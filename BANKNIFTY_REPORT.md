...
|-----------|--------|-----|----------|---------|-------|-----|-------|
| 1min | 3 | 3/0 | **100.0%** | 3.31R | 1.1R | 331.0 | 0/3 |
| 3min | — | — | NO_SETUPS | — | — | — | — |
| 5min | 2 | 2/0 | **100.0%** | 2.0R | 1.0R | 200.0 | 0/2 |

**Best timeframe:** 1min (100.0% WR)
...
|--------|------|------|------|
| Bars available | 3380 | 1131 | 681 |
| OI included | ✅ | ✅ | ✅ |
| Missing values | 0 | 0 | 0 |

---

## Long vs Short Breakdown (1min)
...
|-----------|-----|--------|-----|
| 2026-05-18 13:xx | BUY | SL | +1.0R |
| 2026-05-22 10:xx | BUY | SL | +1.0R |
| 2026-05-27 13:xx | BUY | SL | +1.31R |
